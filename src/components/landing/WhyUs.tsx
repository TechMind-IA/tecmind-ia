        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-6">
              Tecnologia com{' '}
              <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">propósito</span>
            </h2>

            <p className="text-white/40 text-lg leading-relaxed">
              A TechMind AI nasceu para ser o parceiro tecnológico das empresas que querem crescer de verdade. Não somos apenas uma agência. Somos um time que se importa com o seu resultado!
            </p>

            <div className="mt-10">
              <button onClick={scrollToContact} className="px-6 py-3 rounded-full bg-violet-600 hover:bg-violet-500 text-white font-semibold text-sm transition-all duration-200 hover:shadow-lg hover:shadow-violet-500/30">
          ...
          <div className="flex flex-col gap-6">
            {reasons.map((reason) => (
              <div key={reason.number} className="flex gap-6 items-start p-6 rounded-2xl border border-white/5 bg-white/[0.03] hover:bg-white/5 transition-all duration-300 group">
